...
var sequel = title + ' 2: Even More Super';
...
if (isFavorite === true) {
  ...
  console.log(`I recently the ${title} book.`);
}
...
var books = ['Super Book','Super Book 2: Even more super', 'Red Mars', 'Green Mars', 'Blue Mars'];
